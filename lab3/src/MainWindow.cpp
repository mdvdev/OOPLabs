    ...
    , errorMsg("No errors.")
{
    ...
    connect(ui->sqrtPushButton, &QPushButton::clicked, &inputWidgets.sqrtPushButton, &GUI_Invoker::handleEvent);
    connect(ui->inversePushButton, &QPushButton::clicked, &inputWidgets.inversePushButton, &GUI_Invoker::handleEvent);
    connect(ui->sinPushButton, &QPushButton::clicked, &inputWidgets.sinPushButton, &GUI_Invoker::handleEvent);
    connect(ui->cosPushButton, &QPushButton::clicked, &inputWidgets.cosPushButton, &GUI_Invoker::handleEvent);
    connect(ui->tgPushButton, &QPushButton::clicked, &inputWidgets.tgPushButton, &GUI_Invoker::handleEvent);
    connect(ui->ctgPushButton, &QPushButton::clicked, &inputWidgets.ctgPushButton, &GUI_Invoker::handleEvent);
