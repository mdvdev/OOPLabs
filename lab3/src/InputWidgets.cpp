...
InputWidgets::InputWidgets(MainWindow& mainWindow)
    ...
    , sqrtPushButton(mainWindow, std::make_shared<GUISaveExprCommand>(mainWindow.expr, "sqrt"))
    , inversePushButton(mainWindow, std::make_shared<GUISaveExprCommand>(mainWindow.expr, "inverse"))
    , sinPushButton(mainWindow, std::make_shared<GUISaveExprCommand>(mainWindow.expr, "sin"))
    , cosPushButton(mainWindow, std::make_shared<GUISaveExprCommand>(mainWindow.expr, "cos"))
    , tgPushButton(mainWindow, std::make_shared<GUISaveExprCommand>(mainWindow.expr, "tg"))
    , ctgPushButton(mainWindow,std::make_shared<GUISaveExprCommand>(mainWindow.expr, "ctg"))
